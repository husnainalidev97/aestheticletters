        ...
        >
          <nav className="flex flex-col gap-2 p-6">
            ...
            <Link
              ...
              className={mobileLinkClass("christmas-fonts")}
              onClick={() => setIsOpen(false)}
            >
              Christmas Fonts
            </Link>
            ...
            <Link
              ...
              className={mobileLinkClass("l-in-different-fonts")}
              onClick={() => setIsOpen(false)}
            >
              L in Different Fonts
            </Link>
            <Link
              ...
              className={mobileLinkClass("m-in-different-fonts")}
              onClick={() => setIsOpen(false)}
            >
              M in Different Fonts
            </Link>
            ...
            <Link
              ...
              className={mobileLinkClass("w-in-different-fonts")}
              onClick={() => setIsOpen(false)}
            >
              W in Different Fonts
            </Link>
            ...
            <Link
              ...
              className={mobileLinkClass("h-in-different-fonts")}
              onClick={() => setIsOpen(false)}
            >
              H in Different Fonts
            </Link>
            <Link
              ...
              className={mobileLinkClass("j-in-different-fonts")}
              onClick={() => setIsOpen(false)}
            >
              J in Different Fonts
            </Link>
            <Link
              ...
              className={mobileLinkClass("t-in-different-fonts")}
              onClick={() => setIsOpen(false)}
            >
              T in Different Fonts
            </Link>
