...
export default function RPageContent() {
  ...
  return (
    <>
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-[150px] py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-8 flex flex-col gap-16">
              ...
              >
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight text-on-background">
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg">
                  ...
                  styles, including the popular Bold style, follow the newer
                  Unicode block without any gap.{" "}
                  <Link
              ...
              >
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg mb-8">
                  ...
                  meant head. Ancient Greeks adapted it into rho, then Etruscan and
                  Roman scribes reshaped it into the capital R used today. This
                  same shape later influenced letters in Cyrillic and other
                  alphabets.
                </p>
              ...
              <div className="sticky top-28 space-y-8">
                <div className="p-8 bg-primary-container/10 rounded-2xl border border-primary/10">
                  ...
                  <p className="text-sm text-on-surface-variant leading-relaxed">
                    All letter transforms run in your browser. Nothing you type
                    is sent to a server.
                  </p>
                </div>
              </div>
      ...
      {/* FAQ */}
      <section
        className="max-w-[1440px] mx-auto px-4 md:px-[150px] py-12 md:py-24 scroll-mt-[9rem]"
        id="frequently-asked-questions"
      >
        <h2 className="font-headline text-2xl md:text-4xl font-bold mb-16 text-center text-on-background">
          Frequently Asked Questions
        </h2>
        <FAQAccordion faqs={FAQS} defaultOpenIndex={null} />
      </section>

      {/* Ad Placement */}
      <section className="max-w-[1440px] mx-auto px-4 md:px-[150px] mb-12">
        <div className="w-full h-48 bg-surface-container-lowest border border-outline-variant/20 rounded-xl flex flex-col items-center justify-center gap-2 opacity-50">
      ...
      {/* Explore More */}
      <section
        className="max-w-[1440px] mx-auto px-4 md:px-[150px] pt-8 pb-16 scroll-mt-[9rem]"
        id="explore-more"
      >
        <h2 className="font-headline text-3xl md:text-4xl font-bold mb-3 text-center leading-tight text-on-background">
          Explore More
        </h2>
