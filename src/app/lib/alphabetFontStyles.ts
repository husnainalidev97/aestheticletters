...
const hCapitalSymbolCategories: FontCategory[] = [
  ...
  { name: "Arrow Flip", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "➹" + c + "➷").join("") }] },
  { name: "Dot Edges", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "⦑" + c + "⦒").join("") }] },
  { name: "Angle Wrap", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "⧼" + c + "⧽").join("") }] },
  { name: "Arc Wrap", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "⌠" + c + "⌡").join("") }] },
  { name: "Pulse Brackets", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "⎋" + c + "⎋").join("") }] },
  { name: "Hex Brackets", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "⬡" + c + "⬢").join("") }] },
  { name: "Target Brackets", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "⌖" + c + "⌖").join("") }] },
  { name: "Hazard Brackets", styles: [{ name: "", transform: (text) => text.split("").map((c) => c === " " ? " " : "☢" + c + "☢").join("") }] },
  { name: "Twist Crest", styles: [{ name: "", transform: (text) => "╭⊰ " + text + " ⊱╮" }] },
  { name: "Lunar Shine", styles: [{ name: "", transform: (text) => "✦⁺₊✩☽⋆" + text + "⋆☾✩⁺₊✦" }] },
  { name: "Glow Path", styles: [{ name: "", transform: (text) => "╰┈☆ " + text + " ☆┈╯" }] },
  { name: "Noble Edge", styles: [{ name: "", transform: (text) => "꧁♢✸ " + text + " ✸♢꧂" }] },
  { name: "Star Radiance", styles: [{ name: "", transform: (text) => "⋆˚｡⋆୨✧୧˚ " + text + " ˚୨✧୧⋆｡˚⋆" }] },
  { name: "Glossy Beam", styles: [{ name: "", transform: (text) => "˜”°•.¸✦¸.•°”˜ " + text + " ˜”°•.¸✦¸.•°”˜" }] },
  { name: "Star Night", styles: [{ name: "", transform: (text) => "★.¸¸.•´¯\\•.¸¸.★ " + text + " ★.¸¸.•´¯\\•.¸¸.★" }] },
  { name: "Celestial Spiral", styles: [{ name: "", transform: (text) => "⫷⫸⋆⟆⟡⟆⋆⫷ " + text + " ⫸⋆⟆⟡⟆⋆⫷⫸" }] },
  { name: "Spark Flash", styles: [{ name: "", transform: (text) => "⋆·˚˚°✦ " + text + " ✦°˚˚·⋆" }] },
  { name: "Petal Charm", styles: [{ name: "", transform: (text) => "⊱❀⊰ " + text + " ⊱❀⊰" }] },
  { name: "Star Trail", styles: [{ name: "", transform: (text) => "⊱⋆⊳ " + text + " ⊲⋆⊰" }] },
  { name: "Starfield Wrap", styles: [{ name: "", transform: (text) => "⋆═✩═⋆ " + text + " ⋆═✩═⋆" }] },
  { name: "Sparkle Burst", styles: [{ name: "", transform: (text) => "✧˚·̩̩̥͙˚̩̥̩̥·̩̩̥͙✧·̩̩̥͙˚̩̥̩̥˚·̩̩̥͙✧ " + text + " ✧˚·̩̩̥͙˚̩̥̩̥·̩̩̥͙✧·̩̩̥͙˚̩̥̩̥˚·̩̩̥͙✧" }] },
  { name: "Star Elegance", styles: [{ name: "", transform: (text) => "✦•·.·¯˚·.·• " + text + " •·.·˚¯·.·•✦" }] },
  { name: "Star Touch", styles: [{ name: "", transform: (text) => "(¯★.¸(¯★.¸ " + text + " ¸.★´¯)¸.★´¯)" }] },
  { name: "Stellar Gate", styles: [{ name: "", transform: (text) => "☊⍜⋇≋ " + text + " ≋⋇⍜☋" }] },
  { name: "Enchanted Eye", styles: [{ name: "", transform: (text) => "𓂀 " + text.split("").map((c) => doubleStruckMap[c] ?? c).join("") + " 𓂀" }] },
  { name: "Playful Crown", styles: [{ name: "", transform: (text) => "♕ " + text.split("").map((c) => doubleStruckMap[c] ?? c).join("") + " ♕" }] },
];
