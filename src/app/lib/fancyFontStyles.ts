...
const boldArtisticStyles: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Dotted Calligraphy", transform: (t) => withCombining(applyMap(t, boldScriptMap), ["\u0307"]) },
    { name: "Ringed Bold Art", transform: (t) => withCombining(applyMap(t, boldItalicMap), ["\u030A"]) },
    { name: "Underlined Script", transform: (t) => withCombining(applyMap(t, boldScriptMap), ["\u0332"]) },
    { name: "Tilde Artisan", transform: (t) => withCombining(applyMap(t, boldItalicMap), ["\u0303"]) },
    { name: "Double-Dot Script", transform: (t) => withCombining(applyMap(t, boldScriptMap), ["\u0308", "\u0323"]) },
    { name: "Macron Bold Art", transform: (t) => withCombining(applyMap(t, boldItalicMap), ["\u0304"]) },
...
const monospaceTypewriter: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Hollow Dotted", transform: (t) => withCombining(applyMap(t, doubleStruckMap), ["\u0307"]) },
...
const dynamicTextStyles: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Corrupt Bold", transform: (t) => zalgo(applyMap(t, boldMap), 1, 0, 60) },
    { name: "Shattered Italic", transform: (t) => zalgo(applyMap(t, italicMap), 1, 1, 65) },
    { name: "Neon Slash", transform: (t) => withCombining(applyMap(t, sansSerifBoldItalicMap), ["\u0337"]) },
    { name: "Static Italic", transform: (t) => zalgo(applyMap(t, boldItalicMap), 2, 0, 70) },
    { name: "Energy Bold", transform: (t) => withFrame(applyMap(t, boldMap), "\u26A1", "\u26A1") },
    { name: "Pulse Strike", transform: (t) => withCombining(applyMap(t, sansSerifBoldItalicMap), ["\u0336", "\u0307"]) },
    { name: "Chaos Script", transform: (t) => zalgo(applyMap(t, boldScriptMap), 2, 2, 75) },
...
const blockFrameFonts: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Block + Strike", transform: (t) => withCombining(applyMap(t, negSquaredMap), ["\u0336"]) },
...
const ornateBeautiful: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Ornate Ring", transform: (t) => withCombining(applyMap(t, boldFrakturMap), ["\u030A"]) },
...
const curveFlowStyles: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Wavy Tilde", transform: (t) => withCombining(applyMap(t, scriptMap), ["\u0303"]) },
    { name: "Breeze Italic", transform: (t) => withCombining(applyMap(t, italicMap), ["\u0306"]) },
    ...
    { name: "Spiral Script", transform: (t) => withCombining(applyMap(t, boldScriptMap), ["\u030A", "\u0327"]) },
    { name: "Gentle Wave", transform: (t) => withFrame(applyMap(t, italicMap), "\u2E3E", "\u2E3E") },
    { name: "Silk Thread", transform: (t) => withCombining(applyMap(t, scriptMap), ["\u0332", "\u0307"]) },
