...
const boldArtisticStyles: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Dotted Calligraphy", transform: (t) => withFrame(applyMap(t, boldScriptMap), "\u00B7", "\u00B7") },
    { name: "Ringed Bold Art", transform: (t) => withFrame(applyMap(t, boldItalicMap), "\u25CB", "\u25CB") },
    { name: "Underlined Script", transform: (t) => withFrame(applyMap(t, boldScriptMap), "\u2500", "\u2500") },
    { name: "Tilde Artisan", transform: (t) => withFrame(applyMap(t, boldItalicMap), "~", "~") },
    { name: "Double-Dot Script", transform: (t) => withFrame(applyMap(t, boldScriptMap), ":", ":") },
    { name: "Macron Bold Art", transform: (t) => withFrame(applyMap(t, boldItalicMap), "\u2014", "\u2014") },
    ...
    { name: "Emblem Bold", transform: (t) => withFrame(applyMap(t, boldMap), "⟪", "⟫") },
    { name: "Stellar Script", transform: (t) => withFrame(applyMap(t, boldScriptMap), "✦", "✦") },
    { name: "Arrow Artisan", transform: (t) => withFrame(applyMap(t, boldItalicMap), "➤", "") },
  ],
};
...
const fancyLineEffects: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Wavy Below", transform: (t) => withCombining(t, ["\u0330"]) },
    { name: "Hook Accent", transform: (t) => withCombining(t, ["\u0309"]) },
  ],
};
...
const monospaceTypewriter: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Hollow Dotted", transform: (t) => withFrame(applyMap(t, doubleStruckMap), "\u2022", "\u2022") },
    ...
    { name: "Mono Star", transform: (t) => withFrame(applyMap(t, monospaceMap), "⊹", "⊹") },
  ],
};
...
const symbolEnhanced: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Starry Night", transform: (t) => withFrame(applyMap(t, boldMap), "★·.·", "·.·★") },
    { name: "Moon Crescent", transform: (t) => withFrame(applyMap(t, italicMap), "☾", "☽") },
  ],
};
...
const dynamicTextStyles: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Corrupt Bold", transform: (t) => withFrame(applyMap(t, boldMap), "\u2593", "\u2593") },
    { name: "Shattered Italic", transform: (t) => withFrame(applyMap(t, italicMap), "\u25AA", "\u25AA") },
    { name: "Neon Slash", transform: (t) => withFrame(applyMap(t, sansSerifBoldItalicMap), "/", "/") },
    { name: "Static Italic", transform: (t) => withFrame(applyMap(t, boldItalicMap), "\u25B8", "\u25C2") },
    { name: "Energy Bold", transform: (t) => withFrame(applyMap(t, boldMap), "\u26A1", "\u26A1") },
    { name: "Pulse Strike", transform: (t) => withFrame(applyMap(t, sansSerifBoldItalicMap), "\u00BB", "\u00AB") },
    { name: "Chaos Script", transform: (t) => withFrame(applyMap(t, boldScriptMap), "\u203B", "\u203B") },
    { name: "Thunder Italic", transform: (t) => withFrame(applyMap(t, sansSerifBoldItalicMap), "⚡", "") },
    { name: "Rocket Bold", transform: (t) => withFrame(applyMap(t, boldItalicMap), "🚀", "") },
  ],
};
...
const blockFrameFonts: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Block + Strike", transform: (t) => withFrame(applyMap(t, negSquaredMap), "\u2502", "\u2502") },
    ...
    { name: "Shade Blocks", transform: (t) => withFrame(applyMap(t, squaredMap), "▓", "▓") },
    { name: "Braille Frame", transform: (t) => withFrame(applyMap(t, negSquaredMap), "⣿", "⣿") },
  ],
};
...
const ornateBeautiful: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Vine Gothic", transform: (t) => withFrame(applyMap(t, frakturMap), "❧", "❧") },
    { name: "Noble Script", transform: (t) => withFrame(applyMap(t, scriptMap), "\u2766", "\u2767") },
    { name: "Vintage Italic", transform: (t) => withFrame(applyMap(t, italicMap), "\u25C6", "\u25C6") },
    ...
    { name: "Ornate Ring", transform: (t) => withFrame(applyMap(t, boldFrakturMap), "\u25C7", "\u25C7") },
    ...
    { name: "Floral Script", transform: (t) => withFrame(applyMap(t, scriptMap), "✿", "✿") },
    { name: "Pearl Fraktur", transform: (t) => withFrame(applyMap(t, boldFrakturMap), "❖", "❖") },
  ],
};
...
const minimalFancyTexts: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Zen Dots", transform: (t) => withFrame(applyMap(t, smallCapsMap), "◦", "◦") },
  ],
};
...
const curveFlowStyles: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Wavy Tilde", transform: (t) => withFrame(applyMap(t, scriptMap), "~", "~") },
    { name: "Breeze Italic", transform: (t) => withFrame(applyMap(t, italicMap), "\u2248", "\u2248") },
    ...
    { name: "Spiral Script", transform: (t) => withFrame(applyMap(t, boldScriptMap), "\u25E6", "\u25E6") },
    { name: "Gentle Wave", transform: (t) => withFrame(applyMap(t, italicMap), "\u2E3E", "\u2E3E") },
    { name: "Silk Thread", transform: (t) => withFrame(applyMap(t, scriptMap), "\u2500", "\u2500") },
    { name: "Cloud Script", transform: (t) => withFrame(applyMap(t, boldScriptMap), "\u2601\uFE0E", "\u2601\uFE0E") },
    { name: "Feather Script", transform: (t) => withFrame(applyMap(t, scriptMap), "🪶", "") },
    { name: "Heart Flow", transform: (t) => withFrame(applyMap(t, boldScriptMap), "♡", "♡") },
    { name: "Ribbon Curve", transform: (t) => withFrame(applyMap(t, scriptMap), "🎀", "🎀") },
  ],
};
...
const decorativeDotMarks: FancyFontCategory = {
  ...
  styles: [
    { name: "Dot Ring", transform: (t) => withCombining(t, ["\u0307", "\u030A"]) },
    { name: "Underline Dot", transform: (t) => withCombining(t, ["\u0323", "\u0332"]) },
...
const artisticFonts: FancyFontCategory = {
  ...
  styles: [
    ...
    { name: "Sparkle Art", transform: (t) => withFrame(applyMap(t, scriptMap), "✨", "✨") },
    ...
    { name: "Solar Flare", transform: (t) => withFrame(applyMap(t, boldMap), "☀️", "☀️") },
    { name: "Dragon Script", transform: (t) => withFrame(applyMap(t, boldFrakturMap), "🐉", "") },
    { name: "Quill Ink", transform: (t) => withFrame(applyMap(t, boldScriptMap), "🖋️", "") },
    { name: "Matrix Code", transform: (t) => withFrame(applyMap(t, monospaceMap), "⟨", "⟩") },
  ],
};
