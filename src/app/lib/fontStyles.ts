...
const softAesthetic: FontCategory = {
  ...
  styles: [
    ...
    { name: "Dotted Dream", transform: (t) => withFrame(applyMap(t, italicMap), "·˚ .", ". ˚·") },
...
const darkAesthetic: FontCategory = {
  ...
  styles: [
    ...
    { name: "Void Sans", transform: (t) => applyMap(t, monospaceMap) },
    { name: "Shadow Rune", transform: (t) => withFrame(applyMap(t, boldFrakturMap), "᛫᛫", "᛫᛫") },
...
const gothic: FontCategory = {
  ...
  styles: [
    ...
    { name: "Aged Fraktur", transform: (t) => withFrame(applyMap(t, frakturMap), "☙", "❧") },
...
const cottagecore: FontCategory = {
  ...
  styles: [
    ...
    { name: "Pearl Script", transform: (t) => withFrame(applyMap(t, scriptMap), "⊹₊˚", "˚₊⊹") },
    ...
    { name: "Old Letter", transform: (t) => withFrame(applyMap(t, frakturMap), "〖", "〗") },
...
const layered: FontCategory = {
  ...
  styles: [
    ...
    { name: "Glitch Ultra", transform: (t) => withFrame(applyMap(t, sansSerifBoldMap), "⌈⌊", "⌋⌉") },
    { name: "Glitch Ultra Heavy", transform: (t) => withFrame(applyMap(t, boldMap), "█▓▒", "▒▓█") },
    { name: "Glitch Italic", transform: (t) => withFrame(applyMap(t, sansSerifItalicMap), "⫷", "⫸") },
    { name: "Shadow Bold", transform: (t) => withFrame(applyMap(t, boldMap), "░▒▓", "▓▒░") },
    { name: "Shadow Italic", transform: (t) => withFrame(applyMap(t, boldItalicMap), "▒░", "░▒") },
