...
// 15 Unicode serif text-transform styles
// ---------------------------------------------------------------------------
...
// Style 1: Bold Serif — U+1D400/U+1D41A, digits U+1D7CE
const boldSerifMap = { ...buildMap(0x1d400, 0x1d41a), ...buildDigitMap(0x1d7ce) };

// Style 2: Italic Serif — U+1D434/U+1D44E (h=U+210E)
const italicSerifMap = buildMap(0x1d434, 0x1d44e, { h: "\u210E" });

// Style 3: Bold Italic Serif — U+1D468/U+1D482
const boldItalicSerifMap = buildMap(0x1d468, 0x1d482);

// Style 4: Script Serif — U+1D49C/U+1D4B6 with exceptions
...
// Style 5: Bold Script Serif — U+1D4D0/U+1D4EA
const boldScriptSerifMap = buildMap(0x1d4d0, 0x1d4ea);

// Style 6: Double Struck — U+1D538/U+1D552 with exceptions, digits U+1D7D8
...
// Style 7: Fraktur — U+1D504/U+1D51E with exceptions
const frakturMap = buildMap(0x1d504, 0x1d51e, {
  C: "\u212D", H: "\u210C", I: "\u2111", R: "\u211C", Z: "\u2128",
});

// Style 8: Bold Fraktur — U+1D56C/U+1D586
const boldFrakturMap = buildMap(0x1d56c, 0x1d586);

// Style 9: Small Caps — individual lookup
...
// Style 10: Wide Serif — fullwidth U+FF21/U+FF41, digits U+FF10
const wideSerifMap = { ...buildMap(0xff21, 0xff41), ...buildDigitMap(0xff10) };

// Style 13: Circled — U+24B6/U+24D0, digits special
...
// Style 14: Negative Circled — U+1F150, uppercase only
...
// Style 15: Squared — U+1F130, uppercase only
