          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8 flex flex-col gap-16">
              ...
              <article>
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg">
                  <strong>Pro tip:</strong> Use the bold sans serif style (&#x1D5F9;&#x1D5F6;&#x1D5F8;&#x1D5F2; &#x1D601;&#x1D5F5;&#x1D5F6;&#x1D600;) for important words. Use regular or spaced non serif for a lighter, more elegant look. Both styles are available right here in the generator above. For 140+ styles built specifically for Discord, see our <Link href="/discord-fonts" className="text-primary underline underline-offset-4 hover:no-underline">discord fonts</Link> page.
                </p>
              </article>
