...
export default function sitemap(): MetadataRoute.Sitemap {
  /* Site-wide AdSense display units added on 09 Sep 2026 */
  ...
  const toolsHub = {
    ...
    lastModified: serifFontsUpdated,
    changeFrequency: "weekly" as const,
    priority: 0.9,
  };
  ...
  const toolPages = [
    ...
    },
    {
      ...
      images: [
        ...
        `${SITE_URL}/how-to-use-serif-font-generator.webp`,
        `${SITE_URL}/unicode-serif-text-vs-traditional-serif-fonts.webp`,
        `${SITE_URL}/serif-fonts-history-and-origins.webp`,
        `${SITE_URL}/8-serif-font-styles.webp`,
        `${SITE_URL}/serif-vs-sans-serif-when-to-use.webp`,
      ],
    },
    {
  ...
  const alphabetPages = [
    ...
    {
      url: `${SITE_URL}/h-in-different-fonts`,
      lastModified: alphabetPagesUpdated,
      changeFrequency: "weekly" as const,
      priority: 0.7,
    ...
    {
      url: `${SITE_URL}/g-in-different-fonts`,
      lastModified: gPageUpdated,
      changeFrequency: "weekly" as const,
      priority: 0.7,
      images: [`${SITE_URL}/og-g-in-different-fonts.webp`],
    },
    {
      url: `${SITE_URL}/l-in-different-fonts`,
      lastModified: lPageUpdated,
      changeFrequency: "weekly" as const,
      priority: 0.7,
    ...
    {
      url: `${SITE_URL}/s-in-different-fonts`,
      lastModified: alphabetPagesUpdated,
      changeFrequency: "weekly" as const,
      priority: 0.7,
      images: [`${SITE_URL}/og-s-in-different-fonts.webp`],
    },
  ];
