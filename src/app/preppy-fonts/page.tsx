...
export const metadata: Metadata = {
  title: { absolute: "Preppy Fonts Generator: Copy Paste 140+ Preppy Text Styles" },
  description:
    "Generate preppy fonts for your display name, server, or bio in seconds. This free preppy font generator has 140+ preppy text styles, ready to copy and paste.",
  alternates: {
  ...
  openGraph: {
    ...
    title: "Preppy Fonts Generator: Copy Paste 140+ Preppy Text Styles",
    description:
      "Generate preppy fonts for your display name, server, or bio in seconds. This free preppy font generator has 140+ preppy text styles, ready to copy and paste.",
    images: [{ url: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-og.webp", width: 1200, height: 640 }],
  },
  twitter: {
...
const faqs = [
  {
    question: "Do preppy fonts work in usernames?",
    answer:
  ...
  {
    question: "What font does Preppy use by default?",
    answer:
      "Preppy uses gg sans for its app interface and chat text. This replaced an older font called Whitney in December 2022.",
  },
  {
    question: "Do preppy fonts work on mobile?",
    answer:
      "Yes. Since these are Unicode characters and not installed fonts, they display the same way on Preppy desktop, web, iOS, and Android.",
  },
  {
    question: "Why do some preppy text styles show as boxes?",
    answer:
  ...
  {
    question: "Is using stylized letters against Preppy\u2019s rules?",
    answer:
      "No. Nothing about this involves tricking Preppy or exploiting a bug; you\u2019re just sending characters that have existed in Unicode for years, the same way emoji or accented letters do. Preppy renders them like any other text.",
  },
  {
  ...
  {
    question: "Do I need Preppy Nitro to use these fonts?",
    answer:
      "No. Preppy fonts are free Unicode text, available to every account type. Nitro adds separate features, but it has no effect on Unicode styling.",
  },
  {
    question: "How do I make small font preppy text?",
    answer:
...
export default function PreppyFontsPage() {
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: "https://www.aestheticletters.com/preppy-fonts",
        name: "Preppy Fonts Generator: Copy Paste 140+ Preppy Text Styles",
        description:
          "Generate preppy fonts for your display name, server, or bio in seconds. This free preppy font generator has 140+ preppy text styles, ready to copy and paste.",
        inLanguage: "en",
      ...
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/preppy-fonts#image-where-they-work",
        url: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-where-they-work.webp",
        contentUrl: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-where-they-work.webp",
        width: 1200,
        height: 672,
        caption: "Preppy interface showing where Unicode fonts work — display names, server names, categories, roles, and bios support styled text while usernames and channel names do not",
        inLanguage: "en",
      },
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/preppy-fonts#image-boxes-fix",
        url: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-boxes-fix.webp",
        contentUrl: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-boxes-fix.webp",
        width: 1200,
        height: 672,
        caption: "Comparison showing Preppy fonts rendering correctly on desktop but appearing as empty boxes on mobile, with a tip that Small Caps and Bold styles work on all devices",
        inLanguage: "en",
      },
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/preppy-fonts#image-how-to-use",
        url: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-how-to-use.webp",
        contentUrl: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-how-to-use.webp",
        width: 1200,
        height: 672,
        caption: "5-step guide showing how to use Preppy fonts: type your text, pick a style, click copy, open Preppy, and paste to send your styled message",
        inLanguage: "en",
      },
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/preppy-fonts#image-server-styles",
        url: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-server-styles.webp",
        contentUrl: "https://www.aestheticletters.com/images/preppy-fonts/preppy-fonts-server-styles.webp",
        width: 1200,
        height: 672,
        caption: "Six Preppy server examples showing the best font style for each type: Gothic for Gaming, Script for Art, Monospace for Tech, Script with Korean brackets for K-pop, Small Caps for Community, and Zalgo for Horror servers",
        inLanguage: "en",
      },
      {
        "@type": "BreadcrumbList",
  ...
  const howToJsonLd = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to Use Preppy Fonts",
    description:
      "Using a preppy font styles your name or server without any app, plugin, or Nitro subscription.",
    totalTime: "PT1M",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
        name: "Display name",
        text: "Type your text into the generator above and pick a style. Copy it, then open Preppy and go to User Settings, then My Account, then Profiles. Paste your styled text into the Display Name field and save.",
      },
      {
        "@type": "HowToStep",
        position: 2,
      ...
      },
      {
        ...
        position: 5,
        name: "Chat message",
        text: "Paste your styled preppy fonts directly into the message box and send. No extra steps are needed, since message fields accept Unicode the same way display names do.",
      },
    ],
  };
      ...
      <main id="main-content" className="pt-[5.5rem]">
        ...
        <section className="max-w-[1440px] mx-auto px-4 md:px-[150px] pt-8 pb-4 md:pt-10 md:pb-6 text-center">
          <h1 className="font-headline text-2xl md:text-5xl font-bold tracking-tight leading-tight text-on-background mb-2 md:mb-3">
            Preppy Fonts &mdash; Free Copy and Paste
          </h1>
          <p className="font-body text-on-surface-variant max-w-2xl mx-auto mb-4 md:mb-4 text-sm md:text-lg">
            Create preppy fonts in seconds with this free preppy text
            generator. Copy and paste stylish preppy text styles for your
        ...
        <section className="max-w-[1440px] mx-auto px-4 md:px-[150px] py-24 bg-surface-container-low">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8 flex flex-col gap-16">
              {/* What Are Preppy Fonts? */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  What Are Preppy Fonts?
                </h2>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Preppy fonts are not real font files. Preppy cannot install a
                  new font on your device, and it never lets you upload one
                  either. What people call a preppy text font is actually a set
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  ...
                  built to look like styled letters. A preppy font changer
                  simply swaps your normal letters for these lookalike characters.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  This is why a preppy text generator works without any download
                  or app. You are not changing a setting inside Preppy. You are
                  pasting different characters that Preppy could already display
                  before you ever opened this page.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg">
                  Because Unicode is a free public standard, these preppy
              ...
              {/* Where Preppy Fonts Actually Work */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  Where Preppy Fonts Actually Work (and Where They Don&rsquo;t)
                </h2>
                <Image
                  src="/images/preppy-fonts/preppy-fonts-where-they-work.webp"
                  alt="Preppy interface showing where Unicode fonts work — display names, server names, categories, roles, and bios support styled text while usernames and channel names do not"
                  width={1200}
                  height={672}
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  ...
                  username or channel name. They do not. Preppy splits your
                  identity into separate fields, and each field follows its own
                  rules. Knowing the difference saves you a failed paste and a
                  confused friend.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Your Preppy username is the @handle people use to add you as a
                  friend. It only accepts lowercase letters, numbers, periods,
                  and underscores. No styled preppy fonts will ever work here,
                  no matter what tool you use. This is a Preppy rule, not a
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  ...
                  . If you want a preppy name font, this is the field to use.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-8">
                  ...
                  since Preppy forces lowercase letters and hyphens there.
              ...
              {/* Preppy Markdown vs. Unicode Fonts */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  Preppy Markdown vs. Unicode Fonts
                </h2>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Preppy text styles come from two different systems, and most
                  people only discover that when something doesn&rsquo;t work the
                  way they expected.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Preppy Markdown is a built-in formatting system. You type
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  One detail almost no other site explains. Preppy also supports
                  ...
                  normal chat message, Preppy shows it as plain text, brackets
                  and all.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg">
                  Unicode fonts solve a different problem. They work in every
                  field Markdown cannot reach, including your display name,
                  server name, and bio. This generator builds preppy font styles
                  using Unicode characters, so you get styling in the exact
                  places Markdown was never designed to touch.
                </p>
              </article>

              {/* Why Do Some Preppy Fonts Show as Boxes */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  Why Do Some Preppy Fonts Show as Boxes or Missing Letters?
                </h2>
                <Image
                  src="/images/preppy-fonts/preppy-fonts-boxes-fix.webp"
                  alt="Comparison showing Preppy fonts rendering correctly on desktop but appearing as empty boxes on mobile, with a tip that Small Caps and Bold styles work on all devices"
                  width={1200}
                  height={672}
                  className="rounded-xl mb-8 w-full"
                  priority={false}
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg">
                  This generator accounts for these gaps, so your preppy fonts
              ...
              {/* 12 Preppy Font Styles */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  12 Preppy Font Styles to Copy and Paste
                </h2>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  This preppy font generator gives you 12 preppy text styles cards
                  built for real Preppy use, from bold headers to bot command
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Bold Preppy works best for announcements and category headers,
                ...
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Preppy Script fits art, study, and chill community servers
              ...
              {/* How to Use Preppy Fonts */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  How to Use Preppy Fonts?
                </h2>
                <Image
                  src="/images/preppy-fonts/preppy-fonts-how-to-use.webp"
                  alt="5-step guide showing how to use Preppy fonts: type your text, pick a style like Gothic Bold or Script, click copy, open Preppy, and paste to send your styled message"
                  width={1200}
                  height={672}
                  className="rounded-xl mb-8 w-full"
                  priority={false}
                ...
                />
                <p className="text-on-surface-variant leading-relaxed text-lg mb-8">
                  Using a preppy font styles your name or server without any
                  ...
                  {[
                    {
                      ...
                      title: "Display name",
                      description:
                        "Type your text into the generator above and pick a style. Copy it, then open Preppy and go to User Settings, then My Account, then Profiles. Paste your styled text into the Display Name field and save.",
                    },
                    {
                      step: 2,
                    ...
                    },
                    {
                      ...
                      title: "Chat message",
                      description:
                        "Paste your styled preppy fonts directly into the message box and send. No extra steps are needed, since message fields accept Unicode the same way display names do.",
                    },
                  ].map((item) => (
              ...
              {/* Best Preppy Font Styles by Server Type */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  Best Preppy Font Styles by Server Type
                </h2>
                <Image
                  src="/images/preppy-fonts/preppy-fonts-server-styles.webp"
                  alt="Six Preppy server examples showing the best font style for each type: Gothic for Gaming, Script for Art, Monospace for Tech, Script with Korean brackets for K-pop, Small Caps for Community, and Zalgo for Horror servers"
                  width={1200}
                  height={672}
                  className="rounded-xl mb-8 w-full"
                  priority={false}
                ...
                />
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Different servers benefit from different preppy text styles,
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-on-surface-variant leading-relaxed text-lg">
                      Gaming and competitive servers often lean on Bold Preppy
                  ...
                  <div>
                    ...
                    <p className="text-on-surface-variant leading-relaxed text-lg">
                      Aesthetic and chill servers tend to favor Preppy Script or
                  ...
                  <div>
                    ...
                    <p className="text-on-surface-variant leading-relaxed text-lg">
                      ...
                      clean style like Bold Preppy or Mono Tag, since both stay
              ...
              {/* What Font Does Preppy Use? */}
              <article>
                <h2 className="font-headline text-4xl font-bold mb-8 leading-tight">
                  What Font Does Preppy Use?
                </h2>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  Preppy&rsquo;s app interface, including chat text, menus, and
                  buttons, uses a custom typeface called gg sans. Preppy rolled
                  this out in December 2022, replacing an older licensed font
                  called Whitney.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg mb-6">
                  A separate typeface called Ginto Preppy exists too, but it is
                  only used for Preppy&rsquo;s logo and marketing materials, not
                  the app itself. The two are easy to mix up, since both come
                  from the same brand refresh.
                </p>
                <p className="text-on-surface-variant leading-relaxed text-lg">
                  Neither font matters for preppy fonts copy and paste tools
        ...
        <section className="max-w-[1440px] mx-auto px-4 md:px-[150px] pt-16 pb-8">
          ...
          <p className="text-on-surface-variant text-center text-sm md:text-base mb-10 max-w-xl mx-auto">
            Want more than preppy fonts? Check out these generators for letters,
