...
export default function ChristmasFontsPage() {
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/christmas-fonts#image-before-after",
        url: "https://www.aestheticletters.com/images/christmas-fonts/what-are-christmas-fonts-before-after.webp",
        contentUrl: "https://www.aestheticletters.com/images/christmas-fonts/what-are-christmas-fonts-before-after.webp",
        width: 1536,
        height: 1024,
        caption: "Before and after comparison showing plain text Merry Christmas transformed into five different Unicode Christmas font styles including Old English, Bold Fraktur, Bold Serif, Bold Sans, and Script",
        inLanguage: "en",
      },
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/christmas-fonts#image-how-to-use",
        url: "https://www.aestheticletters.com/images/christmas-fonts/how-to-use-christmas-text-generator-three-steps.webp",
        contentUrl: "https://www.aestheticletters.com/images/christmas-fonts/how-to-use-christmas-text-generator-three-steps.webp",
        width: 1536,
        height: 1024,
        caption: "Three step process to use the Christmas text generator: type your text in the input box, browse festive style cards with live preview, then copy and paste styled text anywhere",
        inLanguage: "en",
      },
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/christmas-fonts#image-styles-comparison",
        url: "https://www.aestheticletters.com/images/christmas-fonts/five-christmas-font-styles-comparison-chart.webp",
        contentUrl: "https://www.aestheticletters.com/images/christmas-fonts/five-christmas-font-styles-comparison-chart.webp",
        width: 1024,
        height: 1536,
        caption: "Comparison chart of five Christmas font styles showing Old English Fraktur, Bold Old English, Christmas Bold, Festive Sans, and Holiday Script each applied to the text Merry Christmas with festive symbol decorators",
        inLanguage: "en",
      },
      {
        "@type": "ImageObject",
        "@id": "https://www.aestheticletters.com/christmas-fonts#image-social-media",
        url: "https://www.aestheticletters.com/images/christmas-fonts/christmas-fonts-work-social-media-platforms.webp",
        contentUrl: "https://www.aestheticletters.com/images/christmas-fonts/christmas-fonts-work-social-media-platforms.webp",
        width: 1024,
        height: 1024,
        caption: "Christmas Unicode text displayed correctly across Instagram bio, WhatsApp message, Discord display name, Facebook post, X tweet, and Telegram showing platform compatibility",
        inLanguage: "en",
      },
    ],
  };
