...
import { facebookFontCategories } from "../lib/facebookFontStyles";
...
const STEP = 2;
const DEFAULT_TEXT = "Facebook Fonts";
...
export default function FacebookFontsClient() {
  ...
  const visibleCategories: FontCategory[] = showAll
    ? facebookFontCategories
    : facebookFontCategories.slice(0, INITIAL_COUNT);
  ...
  const handleGenerate = useCallback(() => {
    ...
    const el = document.getElementById("facebook-font-results");
    if (el) {
      ...
      <section className="max-w-[1440px] mx-auto px-4 md:px-[150px] pb-16">
        <div className="relative w-full max-w-3xl mx-auto space-y-5">
          <div className="relative">
            <textarea
              aria-label="Enter text to transform into Facebook fonts"
          ...
          <CategoryJumpLinks
            categories={facebookCategoryLinks}
